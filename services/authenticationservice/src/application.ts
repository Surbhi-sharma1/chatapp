...
import { TokenHandlerProvider } from './providers/tokenHandlerProvider';
import { GoogleOauth2SignupProvider } from './providers/google-oauth2-signup.provider';
...
export class AuthenticationserviceApplication extends BootMixin(
  ...
  constructor(options: ApplicationConfig = {}) {
    ...
    this.bind(SignUpBindings.GOOGLE_SIGN_UP_PROVIDER).toProvider(GoogleOauth2SignupProvider)
